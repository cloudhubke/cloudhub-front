...
const renderComponent = () => {
  ...
  switch (componentId) {
    ...
    case 'numbers-swiper':
      ...
      break;
    case 'typed-text':
      const TypedTextExample = lazy(() =>
        import('./examples/TypedTextExample'),
      );
      Component = <TypedTextExample />;
      break;
    case 'accordion':
      const AccordionExample = lazy(() =>
        import('./examples/AccordionExample'),
      );
    ...
    case 'card-product':
      ...
      break;
    case 'card-promo':
      const CardPromoExample = lazy(() =>
        import('./examples/CardPromoExample'),
      );
