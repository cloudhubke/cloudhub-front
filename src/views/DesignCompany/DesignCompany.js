...
const useStyles = makeStyles(theme => ({
  ...
  sectionAlternate: {
    ...
    backgroundImage: `linear-gradient(180deg, ${theme.palette.tertiary.main} 100%, ${theme.palette.background.paper} 0%)`,
    [theme.breakpoints.up('md')]: {
      backgroundImage: `linear-gradient(180deg, ${theme.palette.tertiary.main} 50%, ${theme.palette.background.paper} 0%)`,
    },
  },
  reviewSection: {
